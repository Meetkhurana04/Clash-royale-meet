...
def api_login():
    ...
    if not u or not check_password_hash(u.password_hash, password):
        # ab hum check kr rhe hote h ki if not u kya username nhi h or chekc pasword hash ek inbuilt fucniton jo ek trf toh db se pasword lega or ek trf huamra fomr wala or check rk
